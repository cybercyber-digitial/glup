...
Each glup task is an asynchronous JavaScript function that either accepts an error-first callback or returns a stream, promise, event emitter, child process, or observable. Due to some platform limitations, synchronous tasks aren't supported.
...
* [glup-cli][glup-cli-external] - the command line interface for interacting with glup
...
[undertaker-external]: https://github.com/glupjs/undertaker
[vinyl-external]: https://github.com/glupjs/vinyl
[vinyl-fs-external]: https://github.com/glupjs/vinyl-fs
[glob-watcher-external]: https://github.com/glupjs/glob-watcher
[bach-external]: https://github.com/glupjs/bach
[last-run-external]: https://github.com/glupjs/last-run
[vinyl-sourcemap-external]: https://github.com/glupjs/vinyl-sourcemap
[glup-cli-external]: https://github.com/glupjs/glup-cli
